# ENTERPRISE.md：多层级仓库导航与路由约定

> **翻译同步说明：** 本翻译可能滞后于英文版 `README.md`（权威版本）。
...
3. 从 [skills/ea-convention/templates/](skills/ea-convention/templates/) 获取相关起始文件到你的仓库中，或通过 `ea-convention` skill 自动生成。
